...
The 160 x 8 canvas previews the selected mode, text, market values, and brightness. It uses a crisp 5 x 7 bitmap alphabet rendered as individual LED dots to closely match the physical matrix. The separate **Preview speed** slider changes only the browser animation and does not change the physical display speed.
